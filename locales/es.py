...
STRINGS: dict[str, str] = {
    ...
    "action_cancelled": "✖️ Cancelado. No se guardó ni se envió nada.",
    # -- cancel appointment --
    ...
    "privacy_message": (
        "🔒 *Privacidad*\n\n"
        "Este bot guarda tu nombre de Telegram, tus preferencias y las citas "
        "que solicites. No lee las conversaciones normales de los grupos y "
        "nunca comparte tu información fuera del liderazgo del ministerio.\n\n"
        "Envía /stop en cualquier momento para eliminar tu registro.\n\n"
        "Toca abajo para leer la política completa."
    ),
    "privacy_button": "Leer la política de privacidad",
    # -- /donate --
    "donate_message": (
    ...
    # -- /announcements --
    "ann_header": "📣 *Anuncios*",
    "ann_none": "No hay anuncios en este momento.",
    "ann_until": "_Válido hasta el {date}_",
    "help_announcements": (
        "*/announcements* — Ver los anuncios actuales de la congregación. "
        "Cada uno se muestra hasta que pase su fecha de expiración."
    ),
